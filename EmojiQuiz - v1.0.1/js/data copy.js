    ...
    questions: {
        movies: {
            ...
            medium: [
                ...
                { emojis: ["🌍", "🌍", "🌍", "🌍"], answer: "El Día de Mañana", options: ["El Día de Mañana", "2012", "Impacto Profundo", "La Tormenta Perfecta"] },
            ...
            hard: [
                ...
                { emojis: ["🎬", "🎬", "🎬", "🎬"], answer: "La La Land", options: ["La La Land", "Moulin Rouge", "Cantando bajo la Lluvia", "Grease"] },
        ...
        countries: {
            ...
            medium: [
                ...
                { emojis: ["🎭", "🎭", "🎭", "🎭"], answer: "Grecia", options: ["Grecia", "Italia", "España", "Portugal"] },
                { emojis: ["🎭", "🎭", "🎭", "🎭"], answer: "Egipto", options: ["Egipto", "Marruecos", "Túnez", "Argelia"] },
                { emojis: ["🎭", "🎭", "🎭", "🎭"], answer: "India", options: ["India", "Pakistán", "Bangladesh", "Sri Lanka"] }
            ],
            hard: [
                ...
                { emojis: ["🎭", "🎭", "🎭", "🎭"], answer: "Brasil", options: ["Brasil", "Argentina", "Colombia", "Perú"] },
                { emojis: ["🎭", "🎭", "🎭", "🎭"], answer: "Rusia", options: ["Rusia", "Ucrania", "Bielorrusia", "Kazajistán"] },
        ...
        history: {
            easy: [
                ...
                { emojis: ["🎭", "🎭", "🎭", "🎭"], answer: "Revolución Francesa", options: ["Revolución Francesa", "Revolución Rusa", "Guerra Civil Inglesa", "Caída del Imperio Romano"] },
                { emojis: ["🎭", "🎭", "🎭", "🎭"], answer: "Primera Guerra Mundial", options: ["Primera Guerra Mundial", "Segunda Guerra Mundial", "Guerra Fría", "Guerra de Vietnam"] },
                { emojis: ["🎭", "🎭", "🎭", "🎭"], answer: "Caída del Muro de Berlín", options: ["Caída del Muro de Berlín", "Revolución Rusa", "Guerra Fría", "Reunificación de Alemania"] }
            ],
            medium: [
                ...
                { emojis: ["🎭", "🎭", "🎭", "🎭"], answer: "Revolución Industrial", options: ["Revolución Industrial", "Revolución Francesa", "Revolución Americana", "Revolución Rusa"] },
                ...
                { emojis: ["🎭", "🎭", "🎭", "🎭"], answer: "Caída del Imperio Romano", options: ["Caída del Imperio Romano", "Caída de Constantinopla", "Caída de Bizancio", "Caída de Roma"] }
            ],
            hard: [
                ...
                { emojis: ["🎭", "🎭", "🎭", "🎭"], answer: "Guerra de los Cien Años", options: ["Guerra de los Cien Años", "Guerra de las Rosas", "Guerra de los Treinta Años", "Guerra de Sucesión"] },
        ...
        science: {
            easy: [
                ...
                { emojis: ["🎭", "🎭", "🎭", "🎭"], answer: "Ley de la Gravedad", options: ["Ley de la Gravedad", "Ley de Newton", "Ley de Einstein", "Ley de Galileo"] },
            ...
            medium: [
                ...
                { emojis: ["🎭", "🎭", "🎭", "🎭"], answer: "Teoría de la Relatividad", options: ["Teoría de la Relatividad", "Teoría de la Gravedad", "Teoría de la Evolución", "Teoría de los Gérmenes"] },
                { emojis: ["🎭", "🎭", "🎭", "🎭"], answer: "Big Bang", options: ["Big Bang", "Expansión del Universo", "Formación de Galaxias", "Formación de Estrellas"] },
                { emojis: ["🎭", "🎭", "🎭", "🎭"], answer: "Fotosíntesis", options: ["Fotosíntesis", "Respiración Celular", "Digestión", "Circulación"] }
            ],
            hard: [
                ...
                { emojis: ["🎭", "🎭", "🎭", "🎭"], answer: "Mecánica Cuántica", options: ["Mecánica Cuántica", "Física Clásica", "Física Relativista", "Física Nuclear"] },
                ...
                { emojis: ["🎭", "🎭", "🎭", "🎭"], answer: "Fusión Nuclear", options: ["Fusión Nuclear", "Fisión Nuclear", "Reacción Química", "Reacción Termonuclear"] }
            ]
        },
        literature: {
            easy: [
                ...
                { emojis: ["🏺", "⚔️", "🏰", "👑"], answer: "La Odisea", options: ["La Odisea", "La Ilíada", "La Eneida", "La Divina Comedia"] }
            ],
            medium: [
                ...
                { emojis: ["👁️", "👁️", "👁️", "👁️"], answer: "1984", options: ["1984", "Un Mundo Feliz", "Fahrenheit 451", "La Naranja Mecánica"] },
                { emojis: ["💃", "🍸", "💎", "🎭"], answer: "El Gran Gatsby", options: ["El Gran Gatsby", "El Viejo y el Mar", "Las Uvas de la Ira", "Por Quién Doblan las Campanas"] }
            ],
            hard: [
                { emojis: ["🏠", "🧠", "💊", "💊"], answer: "1984", options: ["1984", "Un Mundo Feliz", "Fahrenheit 451", "La Naranja Mecánica"] },
        ...
        technology: {
            ...
            medium: [
                ...
                { emojis: ["🎭", "🎭", "🎭", "🎭"], answer: "Blockchain", options: ["Blockchain", "Bitcoin", "Criptomonedas", "Smart Contracts"] },
                { emojis: ["☁️", "☁️", "☁️", "☁️"], answer: "Cloud Computing", options: ["Cloud Computing", "Servidor Remoto", "Almacenamiento en Línea", "Backup"] },
                { emojis: ["🤖", "🤖", "🤖", "🤖"], answer: "Inteligencia Artificial", options: ["Inteligencia Artificial", "Machine Learning", "Deep Learning", "Neural Networks"] },
                { emojis: ["⛓️", "⛓️", "⛓️", "⛓️"], answer: "Blockchain", options: ["Blockchain", "Bitcoin", "Criptomonedas", "Smart Contracts"] },
                { emojis: ["☁️", "☁️", "☁️", "☁️"], answer: "Cloud Computing", options: ["Cloud Computing", "Servidor Remoto", "Almacenamiento en Línea", "Backup"] }
            ],
            hard: [
                ...
                { emojis: ["🎭", "🎭", "🎭", "🎭"], answer: "Quantum Computing", options: ["Quantum Computing", "Supercomputadora", "Grid Computing", "Distributed Computing"] },
                ...
                { emojis: ["⚛️", "⚛️", "⚛️", "⚛️"], answer: "Quantum Computing", options: ["Quantum Computing", "Supercomputadora", "Grid Computing", "Distributed Computing"] },
                { emojis: ["🧠", "🧠", "🧠", "🧠"], answer: "Neural Networks", options: ["Neural Networks", "Machine Learning", "Deep Learning", "Artificial Intelligence"] },
                { emojis: ["📡", "📡", "📡", "📡"], answer: "Edge Computing", options: ["Edge Computing", "Cloud Computing", "Fog Computing", "Grid Computing"] }
            ]
        }
